    ...
    queue.append(
        {
            ...
            "analysis_tier": (
                "MULTI_P0" if len(passed) >= 2 else "SINGLE_P0"
            ),
            # Retained field name for downstream compatibility.  It now means
            # the nearest available mapped P0, not an age-defined boundary.
