...
| 阶段 | 职责 | 主要产物 |
|---|---|---|
| 01 | TAIR12 参考组、GFF 扩展与独立 RepeatMasker soft-mask | 标准化 FASTA/GFF、mask 区间 |
| 02 | 源 mask 与注释扩展 mask 覆盖审计 | 覆盖统计 |
| 03 | 三种 mask 的 BISER 识别与边界比较 | SD calls、资源使用日志、RO 映射 |
